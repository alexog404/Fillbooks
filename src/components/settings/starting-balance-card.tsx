    ...
    <div className="bg-surface border border-border rounded-[10px] px-5 py-[18px] mb-4">
      ...
      <form action={formAction} className="flex items-center gap-3 flex-wrap">
        <input
          ...
          disabled={isPending}
          className="text-[13px] px-3 py-2 rounded-lg bg-surface-2 border border-border w-[160px]"
        />
        <button type="submit" disabled={isPending} className="px-[18px] py-2 rounded-lg bg-primary text-white text-[13px] font-bold cursor-pointer">
